                        ...
                        render={({ handleSubmit, invalid, pristine }) => (
                            <Form onSubmit={handleSubmit} loading={loading}>
                                ...
                                <Form.Group widths='equal'>
                                    <Field placeholder='Date' name='date' value={activity.date} component={DateInput} date={true}/>
                                    <Field placeholder='Time' name='time' value={activity.date} component={DateInput} time={true}/>
                                </Form.Group>
                                ...
                                <Button onClick={activity.id ? () => history.push(`/activities/${activity.id}`) : () => history.push('/activities')} floated='right' type='button' content='Cancel' disabled={loading} />
                            </Form>
                        )}
                    />
